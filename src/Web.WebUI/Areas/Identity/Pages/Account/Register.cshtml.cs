...
namespace Web.WebUI.Areas.Identity.Pages.Account;
[AllowAnonymous]
public class RegisterModel : PageModel
{
    ...
    public string[] TypesAccount { get; set; }= new string[]{"Artist", "Listener"}; 
    ...
    public async Task<IActionResult> OnPostAsync(string returnUrl = null)
    {
        ...
        if(Input.TypeAccount !="Artist" && Input.TypeAccount!="Listener")
        {
            ModelState.AddModelError("Input.TypeAccount", $"This type account {Input.TypeAccount} doesn't exist");
            return Page();
        }
